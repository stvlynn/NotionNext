...
// Preload the preferred color mode before React hydrates.
...
(function() {
  ...
  if (darkMode === null) {
    if (defaultAppearance === 'dark') {
      ...
      // Check whether the current hour falls in the dark-mode range.
      const date = new Date()
  ...
  // Apply the html class immediately.
    ...
    return (
      <Html lang={BLOG.LANG}>
        <Head>
          ...
          {/* Set the color mode early to avoid a flash. */}
