...
const filterLinkProps = (props: any) => {
  const {
    placeholderSrc,
    fallbackSrc,
    src,
...
const SmartLink = ({ href, children, ...rest }: any) => {
  ...
  const mergePreservedQueryForStringHref = (value: any) => {
    ...
    Object.entries(preservedQuery).forEach(([key, paramValue]: any) => {
  ...
  const mergePreservedQueryForObjectHref = (value: any) => {
