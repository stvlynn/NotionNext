...
const Accessibility = () => {
  ...
  useEffect(() => {
    ...
    motionQuery.addEventListener('change', (e: any) => setIsReducedMotion(e.matches))
    contrastQuery.addEventListener('change', (e: any) => setIsHighContrast(e.matches))

    return () => {
      motionQuery.removeEventListener('change', (e: any) => setIsReducedMotion(e.matches))
      contrastQuery.removeEventListener('change', (e: any) => setIsHighContrast(e.matches))
    }
  }, [])
  ...
  const increaseFontSize = () => {
    ...
    if (currentIndex < sizes.length - 1) {
      const newSize = sizes[currentIndex + 1] || fontSize
      setFontSize(newSize)
